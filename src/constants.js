export const workExperience = [
	...
	
	{
		...
		• Astamera, <a href="https://www.lopati.cat/activitats/exposicions/30-03-2026/s-c-una-exposicio-conversacional" target="_blank" rel="noopener noreferrer">error torna-ho a intentar</a>, as part of the exhibition S/C: una exposició conversacional, Centre de arts Lo Pati (Amposta), april 2026
		• Orenetes, BOTCAMPLab 2026, as part of festival Eufònic, Tivissa, july 2026
...
• Musical performing: Piano`,
	...
	},
	{
		...
		description: `
		480 hours of Data Science training. Development of professional skills in the following areas:

		Fundamentals of data science, statistics and programming with Python.

Data analysis:
Introduction to data science and data access, SQL databases, Data exploration, Feature Engineering, Data visualization. 

Machine learning: 
Supervised learning, Unsupervised learning, Deep learning, Time Series

Data Science and Business:
Data Science Productization, Storytelling and data products.`
		,
		technologies: ["Python", "Artificial Intelligence (AI)", "Machine Learning", "Data Analysis", "Data Science"]
	},
	{
